 ...
 */
@MyDataHarborMarker(title = "clickhouse-0.2.x输出源")
public class JdbcClickhouse02xSink extends JdbcSink {

  public JdbcClickhouse02xSink(JdbcSinkConfig jdbcSinkConfig) {
  ...
  @Override
  public String name() {
    return super.name() + "clickhouse-0.2.x";
  }
